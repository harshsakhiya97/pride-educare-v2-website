...
const EnrollCourseListing = () => {
  ...
  // console.log("viewedData", viewedData?.list?.slice(0, 5));
    ...
    <>
      ...
      <section>
        <div className="container">
          <div className="row">
            {enrollData?.list?.length !== 0 ? (
              <div className="col-12">
                <h3 className="section-heading">
                  Enrolled Courses - {enrollData.totalCount}
                </h3>
              </div>
            ) : (
              <>
                <div className="text-center">
                  <h3 className="section-heading">
                    You've Not Enrolled In Any Courses, Explore Some Courses
                    Below or <Link to="/courses">Here</Link>
                  </h3>
                </div>
                {viewedData?.list?.slice(2, 14).map((view, index) => (
                  <>
                    <div className="col-sm-3" key={index}>
                      <Link to={`/buy-now/${view.courseMasterId}`}>
                        <div className="course-module w-100">
                          {view.courseThumbnail?.filePath ? (
                            <img
                              src={view.courseThumbnail?.filePath}
                              className="w-100 img-responsive"
                              alt={view.courseName}
                              title={view.courseName}
                            />
                          ) : (
                            <img
                              src={placeHolderSvg}
            ...
            {enrollData?.list?.map((data) => (
              <>
                <div className="col-sm-3">
                  <Link
                    to={`/enrolled-courses-details/${data.enrollCourseContainMasterId}`}
                  >
                    <div className="course-module w-100">
                      {data.courseMaster.courseThumbnail?.filePath ? (
                        <img
                          src={data.courseMaster.courseThumbnail?.filePath}
                          className="w-100 img-responsive"
                          alt={data.courseMaster.courseName}
                          title={data.courseMaster.courseName}
                        />
                      ) : (
                        <img
                          src={placeHolderSvg}
                      ...
                      <div className="course-details">
                        <h4
                          ...
                          title={data.courseMaster?.courseName}
                        >
                          {data.courseMaster?.courseName}
                        </h4>

                        <div className="course-progress-bar">
                          <div className="progress" style={progressBarStyle}>
                            <div
                              style={data.innerBarStyle}
                              className="progress-bar"
                              role="progressbar"
                              aria-valuenow={data.innerBarStyle.width}
                              aria-valuemin="0"
                              aria-valuemax="100"
                            ></div>
                          </div>
                          <span>{data.innerBarStyle.width}</span>
                        </div>
                      </div>
                    </div>
                  </Link>
...
export default EnrollCourseListing;
